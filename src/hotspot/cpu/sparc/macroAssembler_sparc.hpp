...
public:
 ...
 public:
  ...
  // Continuation fast path stores an unbiased stack address in JavaThread.
  // G1/G3 are volatile scratch registers used by these helpers.
  ...
  // Patchable marker emitted immediately after calls that may be deoptimized.
  void post_call_nop();
